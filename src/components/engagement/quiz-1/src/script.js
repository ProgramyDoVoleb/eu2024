	...
	data: function () {
		return {
			list: [
				...
				{question: "Můžeme v eurovolbách volit ze zahraničí?", options: ["ano", "ne"], correct: 1, selected: null, comment: "Není to možné. Pro eurovolby je nutné být na území České republiky. Jen tak můžete vybírat z kandidátek registrovaných v České republice. Pokud máte přechodné nebo trvalé bydliště v jiné zemi EU a jste zapsaní na tamní seznam voličů, můžete v eurovolbách volit, ale strany a kandidáty vybíráte z místních registrovaných stran."},
				...
				{question: "Kdy nejdříve se dozvíme výsledky?", options: ["v sobotu po 14:00", "v sobotu po 22:00", "v neděli po 23:00", "v pondělí po 12:00"], correct: 2, selected: null, comment: "Eurovolby jsou speciální, na výsledky se mnusí počkat až do uzavření všech místností v celé Evropské unii v neděli ve 23:00. Ihned poté mohou být výsledky zveřejněné."},
